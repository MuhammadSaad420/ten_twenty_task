...
class _ApiService implements ApiService {
  ...
  @override
  Future<UpcomingMovieResponse> fetchUpcomingMovies({required int page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UpcomingMovieResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late UpcomingMovieResponse _value;
    try {
      _value = UpcomingMovieResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GenreResponse> fetchGenres() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenreResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<VideoResponse> fetchVideos({required int movieId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
